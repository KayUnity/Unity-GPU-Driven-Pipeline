...
namespace MPipeline
{
    ...
    public unsafe sealed class ReflectionEvent : PipelineEvent
    {
        ...
        {
            RenderPipeline.AfterFrameBuffer.EnableShaderKeyword("ENABLE_REFLECTION");
        }

        protected override void OnDisable()
        {
            RenderPipeline.AfterFrameBuffer.DisableShaderKeyword("ENABLE_REFLECTION");
        }
        ...
        public unsafe struct StoreReflectionData : IJob
        {
            ...
            public void Execute()
            {
                for (int index = 0; index < count; ++index)
                {
                    ...
                    localToWorld.c3.xyz += (float3)vis.center;
